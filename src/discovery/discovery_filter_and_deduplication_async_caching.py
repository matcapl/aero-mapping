...
ENABLE_REVERSE_GEOCODE_CACHE = True # Enable in-memory cache for reverse-geocode
...
# ------------------------------------------------------------------------------
# Async reverse geocode with optional caching
# ------------------------------------------------------------------------------
# Top-level semaphore to limit concurrent Nominatim requests
_REVERSE_GEOCODE_SEMAPHORE = asyncio.Semaphore(10)  # max 10 concurrent requests
...
async def find_suppliers(
    ...
    Optional arguments:
    - deduplicate: merge duplicates based on distance & name (default top-of-file constant)
    - reverse_geocode: fetch human-readable addresses asynchronously (default top-of-file constant)
    """
